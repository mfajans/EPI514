...
#NOTE: Weighting the subsetted data doesn't work  
#overall
svy_brfss <- 
  survey::svydesign(
    id = ~1, 
...
#Subsetting weighted dataset (brfss_svy)

#Cis men 
   svy_brfss_cism<-subset(brfss_svy,gender_re=="Cisgender Men")
#cis women 
    svy_brfss_cisw<-subset(brfss_svy,gender_re=="Cisgender Women")
#Trans men 
    svy_brfss_tm<-subset(brfss_svy,gender_re=="Transgender Men")
#Trans women 
    svy_brfss_tf<-subset(brfss_svy,gender_re=="Transgender Women")
#Non-binary 
    svy_brfss_nb<-subset(brfss_svy,gender_re=="Non-binary")
...
#Sarah's directory
write.csv(weightedprev_overall, "/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/weightedprev_overall.csv", row.names = TRUE) 
#Collrane's 
#write.csv(weightedprev_overall, paste0(outputDir, "weightedprev_overall.csv"), row.names = TRUE) 
...
ggsave(filename="fig2_overall.jpeg", 
       plot= map_overall_plot, 
       device=jpeg, 
       path="/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/", 
       dpi=300)
...
ggsave(filename="fig2_cism.jpeg", 
       plot= map_cism_plot, 
       device=jpeg, 
       path="/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/", 
       dpi=300)
...
ggsave(filename="fig2_cisw.jpeg", 
       plot= map_cisw_plot, 
       device=jpeg, 
       path="/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/", 
       dpi=300)
...
map_nb_sub_plot <-  plot_usmap(
  ...
  scale_fill_manual(values = c("#fff5f0",
                    ...
                    na.value = "#d9d9d9", name = "% unvaccinated")+
  labs(#title = "Percentage of U.S. Adults Unvaccinated Against Influenza, BRFSS, 2015-2019", 
    subtitle = "Non-binary individuals") +
  theme(legend.position = "none")

map_nb_sub_plot 

ggsave(filename="fig2_nb.jpeg", 
       plot= map_nb_sub_plot, 
       device=jpeg, 
       path="/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/", 
       dpi=300)
...
ggsave(filename="fig2_tm.jpeg", 
       plot= map_tm_sub_plot, 
       device=jpeg, 
       path="/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/", 
       dpi=300)
...
ggsave(filename="fig2_tf.jpeg", 
       plot= map_tf_sub_plot, 
       device=jpeg, 
       path="/Users/sarahcox/Desktop/PhD/2020-2021/2021 Spring/S21_EPI514_ApplicationEpiMethods/data/", 
       dpi=300)
