...
#Save to Word doc 
save_as_docx("Table 1a" = table1a, path = paste0(dataDir, "Table1a.docx"))
...
#Save to Word doc 
save_as_docx("Table 1b_UNWEIGHTED" = table1b_unweighted, path = paste0(dataDir, "Table1b_UNWEIGHTED.docx"))
